...
var all = {
    ...
    ,signsFile: path.join(process.env.PWD, 'tmp', 'signs.csv')
    ,signsFileUrl: 'http://a841-dotweb01.nyc.gov/datafeeds/ParkingReg/locations.CSV'

    ,locationsFile: path.join(process.env.PWD, 'tmp', 'locations.csv')
    ,locationsFileUrl: 'http://a841-dotweb01.nyc.gov/datafeeds/ParkingReg/signs.CSV'

    ,shapeFile: path.join(process.env.PWD, 'tmp', 'shapefile.zip')
